...
def get_args(
    ...
    parser.add_argument('-eval_set', default='train', help='Evaluation set', required=False,
    ...
    parser.add_argument('-out_path', help='Path to .pkl classifier generated',
                        default='data/models/wic_linear_bertlast4layers_50.pkl', required=False)
...
if __name__ == '__main__':
    ...
    instances, labels = [], []
    for wic_idx, wic_entry in enumerate(load_wic(args.eval_set)):
        ...
        if (type(ex1_curr_vector)!=torch.Tensor):
            # print(type(ex1_curr_vector),type(torch.Tensor))
